...
let
  ...
  useNumactl = stdenv.hostPlatform.isAarch64 && stdenv.hostPlatform.isLinux;

  libPath = lib.makeLibraryPath ([
    ncurses6 gmp
  ] ++ lib.optional (stdenv.hostPlatform.isDarwin) libiconv
    ++ lib.optional useNumactl numactl);
...
stdenv.mkDerivation rec {
  ...
  # https://downloads.haskell.org/~ghc/8.10.5/
  src = fetchurl ({
    i686-linux = {
    ...
    x86_64-darwin = {
      ...
      sha256 = "sha256:08javwfqd21kglbr1bnhnbjw2cggz1n668vi8kx5hbcnz3plf3zg";
    };
    aarch64-darwin = {
      url = "${downloadsUrl}/${version}/ghc-${version}-aarch64-apple-darwin.tar.xz";
      sha256 = "sha256:02fbcrzcc6m25z3ji867isml38jkg4blry70ljwl3l03zxq4ws03";
    };
  ...
  ] ++ lib.optional stdenv.isDarwin "CFLAGS=--target=${stdenv.hostPlatform.config}"
    ++ lib.optional stdenv.isDarwin "CONF_CC_OPTS_STAGE2=--target=${stdenv.hostPlatform.config}"
